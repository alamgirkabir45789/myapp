    ...
    public class CreateModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            foreach (var file in RequestMission.File)
            {
                ...
                string message = FileSave.SaveImage(out filePath, file, "Uploads/History");

                Model.Entity.AboutUs.History history = new Model.Entity.AboutUs.History()
                {
               ...
               Description = RequestMission.Description,
                ...
                if(count > 0)
                {
                    _notyfService.Success("History has been created successfully!!!");
